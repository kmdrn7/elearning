...
<div class="topbar">
    ...
    <div class="topbar-left">
        <a href="<?= base_url('admin/dashboard') ?>" class="logo">
            <span><img src="<?= base_url('assets/admin/images/logo.png') ?>" alt="" height="24"></span>
            <i><img src="<?= base_url('assets/admin/images/logo-sm.png') ?>" alt="" height="22"></i>
        </a>
    </div>
    <nav class="navbar-custom">
        <ul class="navbar-right d-flex list-inline float-right mb-0">
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"><i class="mdi mdi-bell noti-icon"></i><span class="badge badge-pill badge-info noti-icon-badge">3</span></a>
            ...
            <li class="dropdown notification-list">
                <div class="dropdown notification-list nav-pro-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                        ...
                        <a class="dropdown-item" href="#"><i class="mdi mdi-settings m-r-5"></i> Settings</a>
