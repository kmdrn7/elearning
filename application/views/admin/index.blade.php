    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
                <img class="navbar-brand-logo" src="{{ assets('admin/img/logo.png') }}" title="Remark">
                <span class="navbar-brand-text hidden-xs-down">&nbsp; ADMIN ELEARNING</span>
            </div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false"
                            ...
                            <span class="avatar avatar-online">
                                <img src="{{ assets('admin/img/portraits/5.jpg') }}" alt="...">
                                <i></i>
                            </span>
                        </a>
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-online">
                                                        <img src="{{ assets('admin/img/portraits/2.jpg') }}" alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-off">
                                                        <img src="{{ assets('admin/img/portraits/3.jpg') }}" alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-busy">
                                                        <img src="{{ assets('admin/img/portraits/4.jpg') }}" alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                                <div class="media-body">
